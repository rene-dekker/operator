...
var _ = Describe("Manager controller tests", func() {
	...
	Context("cert tests", func() {
		...
		BeforeEach(func() {
			...
			mockStatus.On("SetDegraded", operatorv1.ResourceNotReady, "Waiting for secret 'calico-node-prometheus-server-tls' to become available", mock.Anything, mock.Anything).Return().Maybe()
