		...
		Context("Initial creation", func() {
			...
			It("should render an elasticsearchComponent", func() {
				expectedCreateResources := []resourceTestObj{
					...
					{"tigera-eck-operator", "", &rbacv1.ClusterRole{}, nil},
					{"tigera-eck-operator", "", &rbacv1.ClusterRoleBinding{}, nil},
					{"tigera-eck-operator", render.ECKOperatorNamespace, &corev1.ServiceAccount{}, nil},
